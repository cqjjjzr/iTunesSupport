...
namespace CLeopardZip
{
    ...
    public class ZipHelper
    {
        ...
        private static bool ZipDirectory2(string folderToZip, ZipOutputStream zipStream, string parentFolderName)
        {
            return ZipDirectory(Directory.GetDirectories(folderToZip)[0], zipStream, parentFolderName);
        }
