...
class CITWindow : public COleDispatchDriver
{
public:
	CITWindow() {} // 调用 COleDispatchDriver 默认构造函数
	CITWindow(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CITWindow(const CITWindow& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
