...
class CITPlaylist : public COleDispatchDriver
{
public:
	CITPlaylist() {} // 调用 COleDispatchDriver 默认构造函数
	CITPlaylist(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CITPlaylist(const CITPlaylist& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
