...
// CITBrowserWindow 包装器类

class CITBrowserWindow : public COleDispatchDriver
{
public:
	CITBrowserWindow() {} // 调用 COleDispatchDriver 默认构造函数
	CITBrowserWindow(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CITBrowserWindow(const CITBrowserWindow& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void put_MiniPlayer(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
	...
	void put_SelectedPlaylist(VARIANT * newValue)
	{
